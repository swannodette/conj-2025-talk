...
*** God bless shadow-cljs 🌟, but the complexity never diminshes
**** Scaling / consolidation
***** Always leads to downward trajectories for non-shareholders
*** Convivial Tools
** ClojureScript provides a simple set of tools to get the job done
