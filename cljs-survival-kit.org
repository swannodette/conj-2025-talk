...
** A significant slide of ClojureScript dev is React
...
*** CLJS+React mature solution for SPAs / Mobile apps 
...
#+begin_src clojure
  ...
  ;; TODO: change state, update label
#+end_src
* UI Components
#+begin_src clojure
#+end_src
...
*** I know a bit, but I asked Claude a bunch of questions for this talk!
** The source is very approachable
*** Really boring code in the best possible way
*** Lots of comments
** Cool Project: GCL docs at the https://clojurescript.org
...
** If you're designing a library you should have strong intuition about problematic pattern
