...
**** After advanced compilation, only a few bytes
...
** GCL is still relevant
*** Improve, cleanup as community sees fit
...
***** But the quality of the thing is forever tied up w/ JavaScript de Jour
