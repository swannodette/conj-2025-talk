...
*** Few benefits, ClojureScript is already =very good=
**** Well inside 1MB, 512K, 256K, 128K clubs, 64K clubs
** <5K, get much smaller and you need to start breaking CLJS expectations
*** `:lite-mode` is just CLJS, everything works
**** We run the whole test sutie against it
