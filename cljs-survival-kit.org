...
#+begin_src clojure
  ...
  (doc js/HTMLElement)
  (refer-global :only '[Date console])
  (Date.)
  (.log console "Hello!")
#+end_src  
...
*** No JS ecosystem interest in fixing the fundamental problems
...
#+begin_src clojure
  (->> (map inc (range 10))
    ...
    into-array))
#+end_src
* The final artifact (20k/6k brotli) 🔍
:PROPERTIES:
:org-image-actual-width: 700
:END:
[[file:smap.jpg]]
...
*** We control it! Improve, cleanup as commuinity see's fit
** Light DOM morphing
*** Morphdom
*** Idiomorph
*** Morphlex
