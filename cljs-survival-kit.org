...
** Need some interactivity on a static website?
*** Absolutely!
...
*** We control it! Improve, cleanup as community sees fit
** Light DOM morphing
...
* Tradeoffs
** One possible approach with a variety of tradeoffs
** But that's not the tradeoff this talk is about
*** Building our own future
**** JavaScript isn't going anywhere and it can work just fine
***** But the quality of the thing is forever tied up w/ JS de jour
